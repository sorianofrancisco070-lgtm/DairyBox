	-- =========================================================
	-- DairyBox – Migration: Add Missing Cooperative Tables
	...
	-- Sales Transactions
	-- NOTE: DEFAULT CURDATE() replaced with NULL to fix Railway MySQL compatibility
	...
	-- Sample products (only inserts if table was just created)
	INSERT IGNORE INTO coop_products (product_code, name, category, unit, selling_price, cost_price, stock_qty, reorder_level, created_by) VALUES
