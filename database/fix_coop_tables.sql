-- =========================================================
-- DairyBox – Fix Coop Tables Migration
-- Run this in TablePlus against Railway database
-- Fixes: missing AUTO_INCREMENT, DEFAULT CURDATE() issue
-- =========================================================

-- Step 1: Drop broken tables (if they exist with wrong structure)
SET FOREIGN_KEY_CHECKS = 0;
DROP TABLE IF EXISTS coop_sale_items;
DROP TABLE IF EXISTS coop_sales;
DROP TABLE IF EXISTS coop_inventory;
DROP TABLE IF EXISTS coop_products;
...
CREATE TABLE coop_products (
    ...
    category        VARCHAR(80)   DEFAULT 'Milk',
    description     TEXT,
...
-- Sales header
-- NOTE: sale_date has NO default (set by PHP via CURDATE())
...
INSERT IGNORE INTO coop_products
    (product_code, name, category, unit, selling_price, cost_price, stock_qty, reorder_level, created_by)
VALUES
